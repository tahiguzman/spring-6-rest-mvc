...
class CustomerControllerTest {
    ...
    void testCreateCustomer() throws Exception {
        ...
        //This takes care of Mockito
        given(customerService.saveNewCustomer(any(CustomerDTO.class)))
                .willReturn(customerServiceImpl.getAllCustomers().get(1));
        //This takes care of the Spring test... maybe
    ...
    void getCustomerById() throws Exception {
        ...
        given(customerService.getCustomerById(customer.getId()))
                .willReturn(customerServiceImpl.getCustomerById(customer.getId())).willReturn(Optional.of(customer));
